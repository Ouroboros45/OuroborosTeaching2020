...
public class BitmapVision {
    ...
    //The code below is customizable and this is how the vision really works
    ...
    //essentially same thing as senseBlue, but a little different because it is on different sides of the field
